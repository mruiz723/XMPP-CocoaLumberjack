...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="XMPPFrameworkSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP18XMPPFrameworkSwift21XMPPBookmarksDelegate_")
...
@interface GCDMulticastDelegate (SWIFT_EXTENSION(XMPPFrameworkSwift)) <XMPPBookmarksDelegate>
@end
...
SWIFT_CLASS("_TtC18XMPPFrameworkSwift19XMPPBookmarksModule")
...
@interface XMPPBookmarksModule (SWIFT_EXTENSION(XMPPFrameworkSwift)) <XMPPStreamDelegate>
...
@interface XMPPPresence (SWIFT_EXTENSION(XMPPFrameworkSwift))
/// ‘urn:xmpp:idle:1’
